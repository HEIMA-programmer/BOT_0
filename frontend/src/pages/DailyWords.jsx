...
export default function DailyWords() {
  ...
  const addToBank = async (wordId, wordText) => {
    try {
      // Use the ID generated by the front end directly as the word_id.
      // Now the backend database already contains all AWL words, with the ids increasing from 1
      // The ID generated by the front end should match the ID in the back-end database
      const validWordId = wordId;
      await wordBankAPI.add(validWordId);
